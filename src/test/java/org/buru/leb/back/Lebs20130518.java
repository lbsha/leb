...
import org.buru.sardine.Functions;
import org.buru.sardine.Functions.IAction;
import org.buru.sardine.Functions.IActionR;
import org.buru.sardine.annotation.Annotations;
import org.buru.sardine.asserts.Asserts;
import org.buru.sardine.collection.Containers;
import org.buru.sardine.concurrent.Concurrents;
import org.buru.sardine.lang.Strings;
import org.buru.sardine.lang.Systems;
import org.buru.sardine.lang.Times;
import org.buru.sardine.log.Logs;
import org.buru.sardine.reflect.Reflects;
 ...
 */
public final class Lebs20130518 {
	// 观察者，被拆解的观察者
	...
	private Lebs20130518() {
	}

	public static Lebs20130518 newInstance() {
		return new Lebs20130518();
	}

	public static Lebs20130518 singleton() {
		return LebsHolder.singletonLebs;
	}

	static private class LebsHolder {
		static private final Lebs20130518 singletonLebs = newInstance();
	}
	...
	public <T> void broadcast(final Object... arguments) throws LebException {
		...
		Functions.forall(wrappersCollection, new IAction<Collection<MethodWrapper>>() {
	...
	public <T> Collection<T> noticeSync(final String hint, final Object... arguments) throws LebException {
		...
		return Functions.forall(futures, new IActionR<Future<T>, T>() {
	...
	static class Status {
		String hint;
		long calledTime = Times.currentNanoseconds();

		final AtomicInteger counter = new AtomicInteger(0);
		// 最后100个hint的调用日志
		final Map<String, String> lastHints = Containers.newLRUHashMap(100);
	...
	static class Dispatcher {
		...
		<T> Collection<Future<T>> dispatch(final Collection<Callable<T>> tasks) {
			return Functions.forall(tasks, new IActionR<Callable<T>, Future<T>>() {
